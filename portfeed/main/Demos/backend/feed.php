...
<div  style=" float: left; width:33%; padding:25px; max-width:350px; min-width:250px;" class="col-md-12 m-b-20">      
                   ...
                   <div  style="border: 1px; border-style: solid; border-color: #cccccc;" class="widget-item narrow-margin">
                  <div  class="controller overlay right"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                  <div  class="tiles green  overflow-hidden full-height" style="max-height:350px">
                    ...
                    <img style="max-width:360px;" src="uploads/cover.jpg" alt="" > </div>
