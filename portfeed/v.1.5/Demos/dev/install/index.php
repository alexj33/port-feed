 ...
 *
 * @author       Port Feed <info@port-feed.com>
 * @author       Matt Gates <matt.gates@jigoshop.com>
 * @copyright    Copyright © 2009-2012 Port Feed Ltd.
	...
	private function insertSQL() {
		...
		if(empty($this->error)) {
			...
			$this->query("
				...
				(10, 'email-activate-subj', 'You''ve activated your account at Port Feed !'),
				(11, 'email-activate-resend-subj', 'Here''s your activation link again for Port Feed'),
				...
				(13, 'email-welcome-subj', 'Welcome to Port Feed '),
				(14, 'email-forgot-success-subj', 'Your password has been reset at Port Feed'),
				...
				(16, 'email-forgot-subj', 'Lost your password at Port Feed?'),
				(17, 'email-forgot-msg', 'Hi {{full_name}},\r\n\r\nYour username is <strong>{{username}}</strong>.\r\n\r\nTo reset your password at Port Feed, please click the following password reset link:\r\n{{reset}}\r\n\r\nSee you soon!'),
				(18, 'email-add-user-subj', 'You''re registered with Port Feed !'),
			...
			$this->query("
				...
				(2, 'a:2:{i:0;s:1:\"2\";i:1;s:1:\"3\";}', 0, 'special', 'Demo Special', 'test.special@port-feed.com', '0bd6506986ec42e732ffb866d33bb14e'),
				(3, 'a:1:{i:0;s:1:\"3\";}', 0, 'user', 'Demo User', 'test.user@port-feed.com', 'ee11cbb19052e40b07aac0ca060c23ee');
			", $params);
