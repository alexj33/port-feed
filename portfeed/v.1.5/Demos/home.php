...
$(document).on('click','#example-item 
 ...
 <div  style="position:fixed; left:36%; top:55%; z-index:9999; height:600px; width:600px; margin: -300px 0 0 -300px;  ">
	...
	<div class="wrapper">
		<ul>
			...
			<li class="example-item" id="modal">
				...
				<p style="  font-family: futura; font-weight: 100; font-size: 25px; width:200px; height:30px; margin: -15px 0 0 -100px;  left:36%; top:33%; position:relative; " href="#">Get started</p>
			</li>
